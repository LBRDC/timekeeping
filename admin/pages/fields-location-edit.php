                      ...
                      <div class="form-row mb-4">
                        <label for="edit_Status">Status<span class="text-danger">*</span></label>
                          <select class="form-control selectpicker" id="edit_Status" data-style="btn-outline-light">
                              ...
                              <option value="active" <?php if($edit_location['status'] == 'active') { echo 'selected'; } ?>>Active</option>
                              <option value="inactive" <?php if($edit_location['status'] == 'inactive') { echo 'selected'; } ?>>Inactive</option>
                          </select>
                      </div>
                      <div class="col-auto">
