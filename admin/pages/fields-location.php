                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-row mb-4">
                      ...
                      <div class="col-auto" id="divDisable" style="display: none;">
                          <a href="javascript:void(0);" id="btnDisable" class="btn btn-outline-danger" data-toggle="modal" data-target="#mdlWarnDisable" data-toggle="tooltip" data-placement="bottom" title="Disable">
                              <i class="fas fa-times-circle"></i>
                          </a>
                      </div>
                      <div class="col-auto" id="divEnable" style="display: none;">
                          <a href="javascript:void(0);" id="btnEnable" class="btn btn-success" data-toggle="modal" data-target="#mdlWarnEnable" data-toggle="tooltip" data-placement="bottom" title="Enable">
