...
<!-- &&& NAVBAR &&& -->
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      ...
      <li class="nav-item <?php if($page == 'employee'){echo 'active';} ?>">
        ...
        <div id="collapseBootstrap" class="collapse <?php if($page == 'employee'){echo 'show';} ?>" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Employees</h6>
            <a class="collapse-item <?php if($activePage == 'employee-manage'){echo 'active';} ?>" href="?page=employee-manage">Employee Records</a>
          </div>
        </div>
      </li>
      <!-- NAV: Timekeeping Management -->
      <li class="nav-item <?php if($page == 'timekeep'){echo 'active';} ?>">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseForm" aria-expanded="true"
          aria-controls="collapseForm">
          <i class="far fa-calendar-alt"></i>
          <span>Timekeeping</span>
        </a>
        <div id="collapseForm" class="collapse <?php if($page == 'timekeep'){echo 'show';} ?>" aria-labelledby="headingForm" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Timekeeping</h6>
            <a class="collapse-item <?php if($activePage == 'timekeep-record'){echo 'active';} ?>" href="?page=timekeep-record">Daily Time Records</a>
            <a class="collapse-item <?php if($activePage == 'timekeep-report'){echo 'active';} ?>" href="?page=timekeep-report">Timekeeping Reports</a>
          </div>
        </div>
      </li>
      <!-- NAV: Fields Management -->
      <li class="nav-item <?php if($page == 'fields'){echo 'active';} ?>">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTable" aria-expanded="true"
          aria-controls="collapseTable">
          <i class="fas fa-list-ul"></i>
          <span>Fields</span>
        </a>
        <div id="collapseTable" class="collapse <?php if($page == 'fields'){echo 'show';} ?>" aria-labelledby="headingTable" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
      ...
      <!-- NAV: User Management -->
      <li class="nav-item <?php if($page == 'adminMng'){echo 'active';} ?>">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePage" aria-expanded="true"
          aria-controls="collapsePage">
          <i class="fas fa-user-shield"></i>
          <span>Management</span>
        </a>
        <div id="collapsePage" class="collapse <?php if($page == 'adminMng'){echo 'show';} ?>" aria-labelledby="headingPage" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Management</h6>
            <a class="collapse-item <?php if($activePage == 'adminMng-user'){echo 'active';} ?>" href="?page=adminMng-user">Users</a>
          </div>
        </div>
      </li>
      <hr class="sidebar-divider">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                <img class="img-profile rounded-circle" src="img/<?php if (isset($_SESSION['user']['admin_img']) && !empty($_SESSION['user']['admin_img'])) {echo $_SESSION['user']['admin_img'];} else {echo 'admin_user.webp';}?>" style="max-width: 60px">
